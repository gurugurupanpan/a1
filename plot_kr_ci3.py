#!/usr/bin/env python3
"""
Krinsky-Robb Confidence Interval Visualization (Version 3)
"""
...
parameters = ['MF × Label', 'MF × LFprefer', 'MF × Label × LFprefer', 'MF × Score (centered)',
              'Tasting label', 'MF × Tasting label', 'MF × Tasting label × LFprefer',
              'ASC', "MF (A' -A)", 'Label']
point_estimates = [415.274, -338.362, 49.827, 92.972, 262.966, -200.372, -496.602, 757.181, 335.432, -150.842]
ci_lower = [259.920, -489.673, -124.345, 47.243, 129.616, -401.291, -755.394, 652.362, 203.711, -252.265]
ci_upper = [569.961, -182.243, 223.466, 138.423, 392.808, 0.225, -238.444, 862.561, 462.235, -47.192]
...
plt.tight_layout()
plt.savefig('krinsky_robb_ci_plot3.png', dpi=300, bbox_inches='tight')
print("Plot saved as 'krinsky_robb_ci_plot3.png'")
...
plt.tight_layout()
plt.savefig('krinsky_robb_ci_ranges3.png', dpi=300, bbox_inches='tight')
print("Plot saved as 'krinsky_robb_ci_ranges3.png'")
